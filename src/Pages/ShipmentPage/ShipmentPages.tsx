    ...
    const handleSubmit = async (values: ShipmentFormValues, { setSubmitting }: FormikHelpers<ShipmentFormValues>) => {
        try {
            ...
            for (let i = 0; i < numberOfChecks; i++) {
                ...
                const response = await API.CRM.PROTECTED.post('/generate_qr_new', dataToSend, {
                    responseType: 'blob',
                });
            ...
            await API.CRM.PROTECTED.put('http://127.0.0.1:5000/update_status_new', {
                status: 'Заказ в пути',
                ...values
            });
